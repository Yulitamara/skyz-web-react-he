...
function App() {
  ...
  const languageDirection = i18n.dir();
  const containerStyles = { direction: languageDirection };
      ...
      <Router>
        ...
        <div className="language-container" style={containerStyles}>
          <Routes>
            ...
            {/* בלוג – רשימה + פוסט */}
            <Route path="/בלוג/" element={<Blogs />} />
            <Route path="/בלוג/:url/" element={<BlogPost />} />
            ...
            {/* Sales */}
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/" element={<Sales />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/ניהול-לידים-4/" element={<LeadManagement />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/ניהול-הזדמנויות/" element={<OpportunityManagement />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/ניהול-מכירות/" element={<SalesManagement />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/ניהול-קשרים-מכירות/" element={<ContactManagement />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/ניהול-פגישות-מכירות/" element={<MeetingsManagement />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/ניהול-ביצועים-מכירות/" element={<PerformanceManagement />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/ענן-מכירות/" element={<SkyzSalesCloud />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/מובייל-מכירות/" element={<SkyzSalesMobile />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/שרשור-workflow-מכירות/" element={<SalesWorkflow />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/אינטגרציה-לדואר-אלקטרוני-מכירות/" element={<EmailIntegration />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/שיתוף-מידע-וקבצים-מכירות/" element={<InformationSharing />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/שיתוף-יומנים-מכירות/" element={<CalendarSharing />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/שיתוף-חברתי-מכירות/" element={<SocialSharing />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/תחזית-מכירות/" element={<ForecastSales />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzsales/דוחות-ודשבורד-מכירות/" element={<ReportsAndDashboards />} />

            {/* Marketing */}
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/" element={<Marketing />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/ניהול-קמפיין-אימיילים/" element={<EmailCampaignManagement />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/ניהול-קמפיין-מובייל/" element={<MobileCampaignManagement />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/ניהול-קמפיין-חברתי/" element={<SocialCampaignManagement />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/ניהול-מאגרי-מידע/" element={<DatabaseManagement />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/ניהול-מועדוני-לקוחות/" element={<CustomerClubs />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/אפיון-לקוחות-קיימים/" element={<GenerateCustomerDetails />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/ניתוח-מידע-להתאמה-אישית/" element={<CustomizableInformationAnalysis />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/שיתוף-מידע-שיווק/" element={<InformationSharingMarketing />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/שיתוף-חברתי-שיווק/" element={<SocialSharingMarketing />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/אופטימיזציית-קמפיינים-פרסומיים/" element={<CampaignOptimization />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/בקרת-שיווק-כוללת/" element={<MarketingControl />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/מקסום-לקוחות-חדשים/" element={<MaximizingNewCustomers />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/ניהול-שיווק-מהשטח/" element={<FieldBasedMarketingManagement />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/אוטומציה-של-תהליכים-בשיווק/" element={<MarketingAutomation />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzmarketing/דוחות-ודשבורד-שיווק/" element={<ReportsAndDashboardsMarketing />} />

            {/* Service */}
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/" element={<Service />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/ניהול-קריאות-שירות/" element={<CustomerServiceCallsMgmt />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/ניהול-אירועי-שירות/" element={<CustomerServiceEventsMgmt />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/ניהול-משימות-שירות/" element={<TasksManagement />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/ניהול-חוזי-שירות-sla/" element={<SLA />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/ניהול-שירות-שטח/" element={<FieldBasedServiceMgmt />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/ניהול-ביצועי-שירות/" element={<CustomerServicePerformanceMgmt />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/שיתוף-מידע-וקבצים-שירות/" element={<CustomerServiceInformationMgmt />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/שיתוף-יומנים-שירות/" element={<ShareCalendars />} />
            {/* ❌ הוסרה כפילות שהייתה כאן ל-EmailIntegrationService */}
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/שיתוף-חברתי-שירות/" element={<SocialCustomerService />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/שיתוף-ידע-שירות/" element={<SharingKnowledge />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/טכנולוגיית-ענן/" element={<SkyzServiceCloud />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/מובייל-שירות/" element={<SkyzServiceMobile />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/שרשור-workflow-שירות/" element={<CustomerServiceWorkflow />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/אינטגרציה-לדואר-אלקטרוני-שירות/" element={<EmailIntegrationService />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/בקרת-שירות/" element={<CustomerServiceControl />} />
            <Route path="/skyzcrm-ניהול-קשרי-לקוחות/skyzservice/דוחות-ודשבורד-שירות/" element={<ReportsAndDashboardsService />} />
          </Routes>
          <Footer />
        </div>
      </Router>
